...
const Messages = () => {
  ...
  const handleCreateNewChat = async (e) => {
    ...
    if (newChatType === "class" && (!newChatSection || !newChatSubject)) {
      setNewChatError("Please select section and subject");
      return;
    }
    if (newChatType === "project" && !newChatName.trim()) {
    ...
    try {
      ...
      setNewChatError("Failed to create chat: " + err.message);
    }
  };
  ...
  const handleReportMessageMenu = (messageId) => {
    ...
    <div className="msg">
      ...
      {pendingRequests.length > 0 && (
        <div
          ...
          onClick={() => setSelectedChatRequest(pendingRequests[0])}
                  ...
                  messages.map((msg, idx) => (
                    ...
                    >
                      ...
                      <div style={{display: "flex", alignItems: "flex-start", gap: "5px"}}>
                        ...
                        >
                          {msg.content}
                          {msg.is_flagged && <span style={{marginLeft: "10px"}}>⚠️</span>}
                        </div>
                        <div style={{position: "relative"}}>
                          ...
                          {messageContextMenu === msg.id && (
                            <div style={{position: "absolute", top: "20px", right: 0, backgroundColor: "white", border: "1px solid #ccc", borderRadius: "4px", minWidth: "130px", zIndex: 1000, boxShadow: "0 2px 8px rgba(0,0,0,0.15)"}}>
                              <button
                                onClick={() => {
                                  handleReportMessageMenu(msg.id);
                                }}
        ...
        <>
          ...
          >
            ...
            >
              ...
              >
                <p style={{ marginTop: 0, marginBottom: "8px", fontSize: "12px", color: "#666", fontWeight: "bold" }}>
                  Initial Message:
                </p>
                <p
                  style={{
