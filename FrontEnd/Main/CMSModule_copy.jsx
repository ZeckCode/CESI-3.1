...
export default function CMSModule() {
  ...
  const [activeMainTab, setActiveMainTab] = useState("announcements"); // "announcements", "school", "mission", "contact"
    ...
    <div className="cms-container">
      ...
      <div className="cms-main-tabs" style={{ display: "flex", gap: "10px", marginBottom: "20px", borderBottom: "2px solid #e2e8f0", paddingBottom: "10px" }}>
        <button 
          ...
          style={{ padding: "8px 16px", borderRadius: "8px", border: "none", cursor: "pointer", background: activeMainTab === "announcements" ? "#3b82f6" : "#f1f5f9", color: activeMainTab === "announcements" ? "white" : "black", fontWeight: "600" }}
        >Announcements</button>
        <button 
          onClick={() => setActiveMainTab("school")}
          style={{ padding: "8px 16px", borderRadius: "8px", border: "none", cursor: "pointer", background: activeMainTab === "school" ? "#3b82f6" : "#f1f5f9", color: activeMainTab === "school" ? "white" : "black", fontWeight: "600" }}
        >School Information</button>
        <button 
          onClick={() => setActiveMainTab("mission")}
          style={{ padding: "8px 16px", borderRadius: "8px", border: "none", cursor: "pointer", background: activeMainTab === "mission" ? "#3b82f6" : "#f1f5f9", color: activeMainTab === "mission" ? "white" : "black", fontWeight: "600" }}
      ...
      {activeMainTab === "school" && (
        <PageEditor 
          endpoint="school-info" 
          title="School Information" 
          fields={[
            { key: "school_name", label: "School Name", type: "text" },
            { key: "about_text", label: "About Us Text", type: "richtext" },
          ]} 
        />
      )}
      ...
      {activeMainTab === "mission" && (
        <PageEditor 
          ...
          fields={[
            { key: "mission_text", label: "Mission Statement", type: "richtext" },
            { key: "vision_text", label: "Vision Statement", type: "richtext" },
          ]} 
        />
      )}
      ...
      {activeMainTab === "contact" && (
        <PageEditor 
          endpoint="contact-inquiry" 
          title="Contact & Inquiry" 
          fields={[
            { key: "address", label: "Address", type: "text" },
            { key: "phone_number", label: "Phone Number", type: "text" },
            { key: "email", label: "Email Address", type: "email" },
            { key: "facebook_link", label: "Facebook Link URL", type: "url" },
          ]} 
        />
      )}
