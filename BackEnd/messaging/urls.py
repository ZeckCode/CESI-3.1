...
from .views import (
    ...
    ChatRestrictionViewSet, ChatRestrictionAuditLogViewSet, ProfanityWordViewSet, ChatRequestViewSet,
...
router.register(r'restriction-audit-logs', ChatRestrictionAuditLogViewSet, basename='chatrestrictionauditlog')
